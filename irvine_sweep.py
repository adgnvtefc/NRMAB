...
Results -> real_data_trials/results_irvine_distill3/history/.
"""
...
OUT_DIR = 'real_data_trials/results_irvine_sweep_' + CFG_NAME
...
for seed_i in range(NUM_SEEDS):
    ...
    model, _ = train_cdsqn_agent(cfg, NUM_ACTIONS, learning_rate=TD_LR, model=model, **TRAIN)
    ...
    plot_trials(results, output_dir=OUT_DIR,
