...
Results -> real_data_trials/results_irvine_distill2/history/.
"""
...
for seed_i in range(NUM_SEEDS):
    ...
    model = pretrain_distill(graph, epochs=200, lr=3e-3)
    ...
    plot_trials(results, output_dir="real_data_trials/results_irvine_distill2",
