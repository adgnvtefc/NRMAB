...
Results -> real_data_trials/results_irvine_v3/history/.
"""
import sys
import torch
...
for seed_i in range(NUM_SEEDS):
    ...
    comp.train_cdsqn(graph, NUM_ACTIONS, CASCADE_PROB, learning_rate=3e-4, nodewise=True, dueling=True, **TRAIN)
    ...
    plot_trials(
        results,
        output_dir="real_data_trials/results_irvine_v3",
