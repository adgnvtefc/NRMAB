...
Results -> real_data_trials/results_trap/history/.
"""
...
for seed_i in range(NUM_SEEDS):
    ...
    model = CDSQN(len(graph.nodes), 10, 64, 64, nodewise=True, dueling=True, linear_head=True).to(device)
    ...
    plot_trials(results, output_dir="real_data_trials/results_trap",
